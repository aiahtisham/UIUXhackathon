  ...
  return (
    <div>
      ...
      <main className="flex flex-col justify-center items-center my-10">
        <h6 className="text-[14px] text-[#252B42] font-bold">VISIT OUR OFFICE</h6>
        <h2 className="text-[40px] text-[#252B42] font-bold">We help small bussinesses</h2>
        <h2 className="text-[40px] text-[#252B42] font-bold">with big ideas</h2>
