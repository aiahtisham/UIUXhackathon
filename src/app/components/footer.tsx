...
<div className="bg-slate-50 flex justify-around items-center pr-12 py-10">
          ...
          <nav className="md:flex items-center space-x-3 ">
            <a href="#" className="text-[#23A6F0]  hover:text-black"><FaFacebook className="w-[24px] h-[24px] text size-5 mr-3 ml-2"/></a>
            <a href="#" className="text-[#23A6F0]  hover:text-black"><FaInstagram className="w-[24px] h-[24px] text size-5 mr-3 ml-2"/></a>
            <a href="#" className="text-[#23A6F0]  hover:text-black"><FaTwitter className="w-[24px] h-[24px] text size-5 mr-3 ml-2"/></a>
    ...
    <div className="flex flex-wrap justify-between">
      ...
      <div className="w-full sm:w-1/2 lg:w-[10%] mb-6">
        ...
        <ul className="space-y-3">
          <li><a href="#" className="text-[#737373] text-[14px] font-bold hover:text-gray-300">About Us</a></li>
          ...
          <li><a href="#" className="text-[#737373] text-[14px] font-bold hover:text-gray-300">Blog</a></li>
        </ul>
      </div>
      ...
      <div className="w-full sm:w-1/2 lg:w-[15%] mb-6">
        ...
        <ul className="space-y-3">
          ...
          <li><a href="#" className="text-[#737373] text-[14px] font-bold hover:text-gray-300">Live Chat</a></li>
